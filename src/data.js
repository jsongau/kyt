...
// ---------------------------------------------------------------------------
// MODULE 18 — KYT OS WALKTHROUGH
// Visual, screenshot-based training on how to use KYT OS New Patient Intake
// ---------------------------------------------------------------------------
export const kytOsLessons = [
  {
    id: 'pipeline',
    num: '01',
    title: 'The New Patients Pipeline',
    lede: 'When you open New Patients in KYT OS, you see the live pipeline — every active request grouped by stage. Learn to read it at a glance.',
    screenshot: '/screenshots/kyt-pipeline-view.jpeg',
    screenshotAlt: 'KYT OS New Patients pipeline showing New Request and Contacted sections',
    callouts: [
      { num: 1, label: 'Stage header', detail: '"New Request (4)" means 4 patients are in this stage. No contact event has been recorded yet for any of them.' },
      { num: 2, label: 'Source badge', detail: '"ZocDoc" or "Phone Call" tells you how this patient entered. Each source has its own intake rules.' },
      { num: 3, label: 'Insurance badge', detail: '"PPO" means the patient reported PPO — it is NOT verified yet. A badge alone does not mean we can bill.' },
      { num: 4, label: '"X in lane"', detail: '"4d in lane" = this patient has been in the current stage for 4 days. Older = needs attention first.' },
      { num: 5, label: 'Pipeline buttons', detail: 'Details · Contacted · Registered · Scheduled · Archived. Click these to move the patient forward. Never skip stages without a reason.' },
      { num: 6, label: 'Created by', detail: '"Created by: Jiaming Song" — every record shows who entered it. Accountability starts at creation.' },
    ],
    rules: [
      'Always work oldest-first. "8d in lane" before "4d in lane."',
      'A patient in New Request has NOT been contacted. Do not assume they know about their appointment.',
      'Source badges are informational — they do not change the pipeline buttons.',
      'If a patient shows "PPO" but you have not verified, their status is still Pending — treat it that way.',
    ],
  },
  {
    id: 'pipeline2',
    num: '02',
    title: 'Contacted and Registered Stages',
    lede: 'Further down the pipeline — what Contacted and Registered look like, and the key differences from New Request.',
    screenshot: '/screenshots/kyt-pipeline-registered.jpeg',
    screenshotAlt: 'KYT OS pipeline showing Contacted and Registered patient cards',
    callouts: [
      { num: 1, label: 'Contacted (6)', detail: 'A qualifying contact event was recorded for each of these patients — voicemail, spoke with patient, text, email, or in-person.' },
      { num: 2, label: 'Webflow source', detail: '"Webflow" means the patient submitted the website inquiry form. The record was auto-created. A staff member still needs to contact them to move to Contacted.' },
      { num: 3, label: 'Ortho badge', detail: '"Ortho" badge means ortho coverage was noted in the Ortho Tracker. It is not a verification — it means it was asked about.' },
      { num: 4, label: 'Referral source', detail: '"Referral" — this patient was referred by someone. The referring patient or contact is logged in the record.' },
      { num: 5, label: 'Registered (5)', detail: 'These patients are in the PMS. Registration details are complete. Next action is scheduling.' },
      { num: 6, label: 'Last updated by', detail: '"Last updated by: Alison Chen" — every stage change is attributed. You can see who touched the record last.' },
    ],
    rules: [
      'Webflow and ZocDoc records start in New Request even though they were auto-created. Contact must still happen.',
      'Moving to Registered means the patient is in the PMS with complete registration details — not just that you spoke to them.',
      '"Ortho" badge does not mean ortho is covered. It means you checked and documented the answer.',
      'Last updated by is not the same as created by. Check both when troubleshooting a record.',
    ],
  },
  {
    id: 'new-request',
    num: '03',
    title: 'Creating a New Request — the Form',
    lede: 'Click "+ New" to open the intake form. Every source uses the same form. Fill left side first, then Insurance Tracking on the right.',
    screenshot: '/screenshots/kyt-form-blank.jpeg',
    screenshotAlt: 'KYT OS New Patient Intake form — blank',
    callouts: [
      { num: 1, label: 'Patient Name', detail: 'Enter full legal name — First Last. Search for duplicates before creating. If you see a match in the Household field below, stop and investigate.' },
      { num: 2, label: 'DOB', detail: 'MM/DD/YYYY format. Required for insurance verification. Missing DOB = verification will fail.' },
      { num: 3, label: 'Phone / Email', detail: 'Enter at least one. Phone is preferred. Double-check the number before saving — wrong numbers waste follow-up time.' },
      { num: 4, label: 'Referral Source', detail: 'Select the source first — it sets the context for everything else. Options: ZocDoc, Referral, Webflow, Phone Call, Walk-In. See the next lesson for source-by-source rules.' },
      { num: 5, label: 'Reason', detail: '"New Exam" is the most common. Select accurately — this affects scheduling and clinical prep.' },
      { num: 6, label: 'Comments', detail: 'Use this field for anything not captured elsewhere: "Patient said they have Guardian PPO but couldn\'t find card" · "Left voicemail at 2pm" · "Zocdoc showed Delta but patient said Guardian."' },
      { num: 7, label: 'Link to Household', detail: 'Search by name or phone. If this patient belongs to an existing household, link them. Prevents duplicate family records.' },
      { num: 8, label: 'Insurance Tracking (right panel)', detail: 'Fill this AFTER patient details. Do not default to PPO. Start with what the patient actually told you.' },
    ],
    rules: [
      'Always search for an existing record before creating a new one. Duplicate records break verification and communication.',
      'Fill Referral Source before anything else — it tells you what additional fields to expect.',
      'Use the Comments field generously. If it was said, note it.',
      'Do not create a record with a made-up phone number just to save it. Mark phone as unknown and note it in comments.',
    ],
  },
  {
    id: 'source',
    num: '04',
    title: 'Referral Source — Choosing Correctly',
    lede: 'The Referral Source dropdown controls how KYT OS categorizes the record. Choosing wrong causes reporting errors and missed follow-up logic.',
    screenshot: '/screenshots/kyt-source-dropdown.jpeg',
    screenshotAlt: 'KYT OS Referral Source dropdown showing ZocDoc, Referral, Webflow, Phone Call, Walk-In options',
    callouts: [
      { num: 1, label: 'ZocDoc', detail: 'Patient booked through Zocdoc.com. The 24-hour response window applies. Insurance shown on Zocdoc is patient-reported — verify separately.' },
      { num: 2, label: 'Referral', detail: 'An existing patient, doctor, specialist, or community partner referred this person. Always note who referred them in Comments.' },
      { num: 3, label: 'Webflow', detail: 'Patient submitted the KYT website inquiry form. The record may have been auto-created. Still requires a manual contact event before moving to Contacted.' },
      { num: 4, label: 'Phone Call', detail: 'You are on the phone with the patient now, OR they called and left a message, OR you are entering a callback request. Note which in Comments.' },
      { num: 5, label: 'Walk-In', detail: 'Patient is physically present at the office. Set initial stage to Contacted immediately and begin registration.' },
    ],
    sourceRules: [
      {
        source: 'ZocDoc',
        tone: 'gold',
        startStage: 'New Request',
        contactTarget: 'Within 15 minutes of booking',
        notes: [
          'Insurance shown on Zocdoc is patient-selected — it is NOT verified.',
          'The 24-hour window starts from booking time, not when you see it.',
          'If patient cannot be reached, document every attempt in Comments.',
          'Verify plan type independently — do not trust the Zocdoc display.',
        ],
      },
      {
        source: 'Phone Call',
        tone: 'teal',
        startStage: 'New Request OR Contacted',
        contactTarget: 'Immediate (if live) / Within 10 minutes (if callback)',
        notes: [
          'If you are speaking with the patient right now: create the record AND move to Contacted in the same session.',
          'If it was a missed call: create in New Request, note the missed call in Comments.',
          'If entering a callback request from a voicemail: create in New Request.',
          'Always record the phone number you called, what happened, and timestamp in Comments.',
        ],
      },
      {
        source: 'Walk-In',
        tone: 'teal',
        startStage: 'Contacted (immediately)',
        contactTarget: 'Already here — immediate',
        notes: [
          'Patient is present — skip New Request, start in Contacted.',
          'Begin registration immediately after creating the record.',
          'Collect insurance card front and back while patient is present.',
          'Do not let a walk-in leave without a next step documented.',
        ],
      },
      {
        source: 'Referral',
        tone: 'neutral',
        startStage: 'New Request (unless already spoken to them)',
        contactTarget: 'Same business day',
        notes: [
          'Note the referrer\'s name and relationship in Comments.',
          'If you have already spoken to the referred patient, start in Contacted.',
          'If not yet spoken to them, start in New Request.',
          'Link the referring patient\'s household record when possible.',
        ],
      },
      {
        source: 'Webflow',
        tone: 'neutral',
        startStage: 'New Request (auto-created)',
        contactTarget: 'Within 15 minutes of form submission',
        notes: [
          'Record is auto-created when patient submits the website form.',
          'An automated confirmation email does NOT count as a contact event.',
          'Staff must make a manual call, text, or email to move to Contacted.',
          'Insurance submitted on the web form is patient-reported — not verified.',
        ],
      },
    ],
  },
  {
    id: 'insurance-type',
    num: '05',
    title: 'Insurance Type — How to Choose',
    lede: 'The Insurance Type dropdown determines how the rest of the insurance section behaves. Never default to PPO without the patient telling you.',
    screenshot: '/screenshots/kyt-insurance-type.jpeg',
    screenshotAlt: 'KYT OS Insurance Type dropdown showing PPO, HMO, Medi-Cal, None / Cash options',
    callouts: [
      { num: 1, label: 'PPO', detail: 'Select only if the patient explicitly said they have a PPO plan. A PPO badge does NOT mean it\'s been verified — insurance status must still be set to Pending Verification.' },
      { num: 2, label: 'HMO', detail: 'Patient has an HMO/DHMO plan. KYT is likely NOT their assigned in-network office. Flag immediately — see Membership Plan module for the correct conversation.' },
      { num: 3, label: 'Medi-Cal', detail: 'Patient has Medi-Cal (government dental). Verify Medi-Cal eligibility through the correct portal. Different billing process than PPO.' },
      { num: 4, label: 'None / Cash', detail: 'Patient has no insurance or prefers to pay out-of-pocket. Present self-pay options and/or the KYT Membership Plan.' },
    ],
    rules: [
      'The form defaults to PPO — this is a known issue. Always consciously confirm or change the type based on what the patient told you.',
      'If the patient says "I have dental insurance" but does not know the type, set to PPO Pending Verification and note "plan type unconfirmed" in Comments.',
      'HMO patients cannot use their HMO coverage at KYT unless KYT is their assigned office — verify this before promising any coverage.',
      '"I think I have a PPO" is not confirmation. Note it as patient-reported and verify.',
    ],
  },
  {
    id: 'insurance-status',
    num: '06',
    title: 'Insurance Status — What Each Option Means',
    lede: 'Insurance Status is the most important field for preventing billing surprises. Every option has a precise meaning. Do not guess.',
    screenshot: '/screenshots/kyt-insurance-status.jpeg',
    screenshotAlt: 'KYT OS Insurance Status dropdown showing PPO Pending Verification, PPO Verified, PPO Not Active Until, PPO Invalid / Not Accepted',
    callouts: [
      { num: 1, label: 'PPO Pending Verification', detail: 'Default starting status for any PPO. Means: patient reported PPO, we have not yet confirmed it through the carrier or DentalXChange. Do not schedule major work until this changes.' },
      { num: 2, label: 'PPO Verified', detail: 'Only use this after you have confirmed: (1) plan is active, (2) plan type is PPO, (3) KYT is in-network for this plan. All three must be true.' },
      { num: 3, label: 'PPO Not Active Until…', detail: 'The plan exists but has not activated yet — waiting period or future effective date. Note the activation date in Comments. Do not schedule benefit-dependent work until after that date.' },
      { num: 4, label: 'PPO Invalid / Not Accepted', detail: 'The carrier cannot find the member, the plan is terminated, or KYT is out-of-network. Patient must be informed and offered alternatives (self-pay, membership plan, or correct their insurance info).' },
    ],
    statusGuide: [
      { status: 'PPO Pending Verification', tone: 'gold', when: 'Patient reported PPO but you have not run verification yet', action: 'Run verification before appointment. Do not proceed to major work.' },
      { status: 'PPO Verified', tone: 'teal', when: 'You confirmed active PPO + plan type + KYT in-network — all three', action: 'Bill normally under PPO track. Document verification source and date.' },
      { status: 'PPO Not Active Until…', tone: 'gold', when: 'Plan is real but not yet effective, or has a waiting period', action: 'Note the date. Schedule only if patient understands they pay self-pay until that date.' },
      { status: 'PPO Invalid / Not Accepted', tone: 'red', when: 'Plan cannot be found, is terminated, or KYT is out-of-network', action: 'Inform patient. Offer self-pay, membership plan, or have them contact HR/carrier to correct.' },
    ],
    rules: [
      '"Active" from the carrier portal does NOT automatically mean PPO Verified. Active means the plan is live — it does not confirm plan type or network status.',
      'Never set PPO Verified based on what Zocdoc shows. Zocdoc displays patient-entered data.',
      'If you cannot reach the carrier and the appointment is today: use "Verify at Arrival" and note it in Comments.',
      'When in doubt, leave as Pending. A pending status protects everyone. A false Verified status creates billing errors.',
    ],
  },
  {
    id: 'ortho',
    num: '07',
    title: 'Ortho Tracker — When and How to Use It',
    lede: 'The Ortho Tracker captures whether the patient has orthodontic coverage. Fill it every time — never leave it blank.',
    screenshots: [
      { src: '/screenshots/kyt-ortho-coverage.jpeg', alt: 'Ortho Coverage dropdown showing Yes, No options', caption: 'Step 1 — Ortho Coverage: Does the plan cover ortho?' },
      { src: '/screenshots/kyt-ortho-age-limit.jpeg', alt: 'Age Limit dropdown showing No age limit, Has age limit options', caption: 'Step 2 — Age Limit: Only visible when coverage is Yes or Unknown' },
    ],
    callouts: [
      { num: 1, label: 'Ortho Coverage — Yes', detail: 'Patient\'s plan includes orthodontic coverage. Proceed to Age Limit field.' },
      { num: 2, label: 'Ortho Coverage — No', detail: 'Plan explicitly does not cover ortho. Note it so the clinical team knows before the consult.' },
      { num: 3, label: 'Age Limit — No age limit', detail: 'Ortho coverage applies at any age. Common in comprehensive PPO plans.' },
      { num: 4, label: 'Age Limit — Has age limit', detail: 'A numeric age cap applies (e.g., coverage only for patients under 19). Enter the age in the field that appears.' },
    ],
    rules: [
      'Do not leave Ortho Coverage as "—". Ask the patient or check the plan. Blank = unknown = surprise at the consult.',
      'The "—" default means you have not checked — not that it is covered. These are different things.',
      'Ortho coverage noted in KYT OS is patient-reported or preliminary. Clinical must verify through the carrier before quoting ortho treatment.',
      'Age limit matters most for adult patients seeking Invisalign or braces. Always check before their consult.',
    ],
  },
  {
    id: 'comments',
    num: '08',
    title: 'The Comments Field — How to Write Good Notes',
    lede: 'The Comments field is your running log. Good comments prevent miscommunication, protect the office, and help the next staff member pick up exactly where you left off.',
    screenshot: '/screenshots/kyt-form-blank.jpeg',
    screenshotAlt: 'KYT OS intake form showing Comments field with placeholder text',
    goodExamples: [
      'Left voicemail at 2:14 PM · Patient called back · Confirmed they have Guardian PPO but could not locate member ID · Will text photo of card.',
      'Zocdoc showed Delta Dental but patient said they switched to Aetna in January · Updated carrier to Aetna · Pending verification.',
      'Patient present at front desk · No insurance card · Says they have "some Cigna plan through work" · Set to Pending, will call HR tomorrow.',
      'Ran eligibility through DentalXChange · Returned Active but plan type shows DHMO · Set to HMO · Informed patient KYT is not their assigned office · Offered membership plan.',
      'Referred by Maria Lopez (existing patient, household #1042) · Patient already spoke with Dr. Sun at a community event · Moved to Contacted.',
    ],
    badExamples: [
      { bad: '(blank)', why: 'No record of what happened. The next person has to start from scratch.' },
      { bad: 'called', why: 'Missing: what number, what time, what outcome, what next step.' },
      { bad: 'has ppo', why: 'Who said so? What carrier? What member ID? This is a starting point, not a note.' },
      { bad: 'verified', why: 'Verified how? Through what source? By whom? When? This is not audit-ready.' },
      { bad: 'see zocdoc', why: 'Zocdoc data is patient-reported. "See Zocdoc" is not a verification note.' },
    ],
    rules: [
      'Write as if the next person reading this has no other context.',
      'Include: what you did, when, the outcome, and the next step.',
      'Every contact attempt needs a note — even failed ones.',
      'Never put a patient\'s full SSN or financial data in Comments. Use designated fields.',
    ],
  },
]

export const kytOsPipelineStages = [
  {
    stage: 'New Request',
    tone: 'neutral',
    meaning: 'A booking, inquiry, or referral exists. No qualifying contact has been made yet.',
    countsAs: [
      'ZocDoc booking received',
      'Website form submitted',
      'Phone callback request logged',
      'Email inquiry received',
      'Referral entered but patient not yet contacted',
    ],
    doesNotCountAs: [
      'Automated website confirmation email sent',
      'Automated ZocDoc notification received',
      'Phone rang but no answer and no voicemail',
    ],
    nextAction: 'Contact the patient.',
  },
  {
    stage: 'Contacted',
    tone: 'teal',
    meaning: 'A qualifying contact event occurred. The patient knows KYT is aware of their request.',
    countsAs: [
      'Spoke with patient by phone',
      'Left voicemail at a valid number',
      'Sent a manual text message',
      'Sent a manual email reply',
      'Interacted with patient in person (Walk-In)',
    ],
    doesNotCountAs: [
      'Phone rang without voicemail',
      'Wrong number',
      'Automated system notification only',
      'No attempt made',
    ],
    nextAction: 'Complete registration and verify insurance.',
  },
  {
    stage: 'Registered',
    tone: 'gold',
    meaning: 'Patient is in the PMS with complete registration details. Insurance has been addressed.',
    countsAs: [
      'Patient record created in official PMS',
      'Required registration fields complete',
      'Insurance status confirmed or noted as unresolvable',
    ],
    doesNotCountAs: [
      'Speaking to the patient counts as Contacted, not Registered',
      'Having the patient\'s phone number is not Registration',
    ],
    nextAction: 'Schedule the appointment.',
  },
  {
    stage: 'Scheduled',
    tone: 'teal',
    meaning: 'Patient has a confirmed appointment date and time in the schedule.',
    countsAs: [
      'Appointment booked in the schedule',
      'Patient confirmed date and time',
    ],
    doesNotCountAs: [
      'A ZocDoc booking request is not the same as a confirmed KYT appointment',
    ],
    nextAction: 'Confirm before appointment. Verify insurance if still pending.',
  },
  {
    stage: 'Archived',
    tone: 'red',
    meaning: 'No further active follow-up needed. Always requires an archive reason.',
    reasons: [
      'Patient declined',
      'Duplicate request',
      'Invalid contact information',
      'Patient chose another office',
      'Cancelled without rescheduling',
      'No response after follow-up sequence',
      'Converted — no longer needs pipeline tracking',
      'Other',
    ],
    nextAction: 'Archive with a reason. Record is preserved for history.',
  },
]
